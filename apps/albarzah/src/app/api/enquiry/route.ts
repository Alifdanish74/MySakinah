...
export async function POST(request: Request) {
  try {
    ...
    if (typeof body.telefonKawan === "string") body.telefonKawan = body.telefonKawan.replace(/[\s-]/g, "");
    ...
    if (!parsed.success) {
      console.warn("[Albarzah Enquiry API] Validation failed:", parsed.error.issues);
