  ...
  return (
    <header
      ...
      style={{
        ...
        boxShadow: "0 1px 0 0 rgba(191,168,0,0.15), 0 2px 12px rgba(0,71,60,0.04)",
      }}
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <a
          ...
          aria-label="Albarzah — kembali ke bahagian utama"
        >
        ...
        <a
          ...
          aria-label="Daftar sebagai ahli Albarzah"
        >
          Daftar Sekarang
        </a>
