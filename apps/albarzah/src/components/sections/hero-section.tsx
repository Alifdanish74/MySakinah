...
export function HeroSection() {
  return (
    <section
      ...
      style={
        {
          "--hero-bg-image": "url('/images/albarzah_hero_bg.png')",
    ...
    >
      ...
      <ResponsiveContainer className="flex justify-center">
        <div className="w-full max-w-2xl mx-auto px-4 sm:px-12 md:px-16 text-center flex flex-col items-center">
          ...
          {/* Mosque dome / arch glass container */}
          <div
            ...
            style={{
              ...
              borderWidth: "1.5px",
              boxShadow: "0 16px 48px rgba(0,71,60,0.18)",
            }}
          >
            {/* Eyebrow */}
            <motion.p
            ...
            <motion.h1
              ...
              className="mb-4 text-4xl sm:text-5xl lg:text-6xl font-bold italic leading-tight"
              style={{
            ...
            >
              Ringankan Beban Orang Yang Tersayang Apabila Berlaku Kematian Yang Tidak Diduga — Terbuka Kepada Semua Warganegara Malaysia
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span>Perlindungan Maksimum Sehingga Umur 75 Tahun</span>
              </div>
            </motion.div>
            ...
            >
              <a
                ...
                className="hover-scale flex flex-1 items-center justify-center gap-2 rounded-full py-3.5 px-6 text-sm font-bold transition-all shadow-md"
                style={{
