...
export function HeroSection() {
  return (
    <section
      ...
      style={
        {
          "--hero-bg-image": "url('/kotamas/images/opening_background_desktop.png')",
    ...
    >
      ...
      <style jsx global>{`
        ...
        @media (max-width: 639px) {
          .hero-bg::before {
            background-image: url('/kotamas/images/opening_background.png') !important;
          }
        }
      `}</style>
      ...
      <ResponsiveContainer className="flex justify-center">
        ...
        <div className="w-full max-w-2xl mx-auto px-4 sm:px-12 md:px-16 text-center flex flex-col items-center">
          ...
          >
            ...
            >
              Ringankan Beban Orang Yang Tersayang Apabila Berlaku Kematian Yang Tidak Diduga Dengan Skim Khairat Potongan Gaji Bulanan Kota Mas.
            </motion.p>
            ...
            >
              <a
                ...
                aria-label="Lihat pilihan pakej perlindungan Kota Mas"
              >
                Lihat Pilihan Pakej
