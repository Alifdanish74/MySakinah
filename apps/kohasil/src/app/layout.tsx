...
export const metadata: Metadata = {
  metadataBase: new URL(
    process.env.NEXT_PUBLIC_SITE_URL || "https://kohasil.mysakinah.com"
  ),
  title: "KOHASiL Raudhah — Skim Pengurusan Jenazah & Khairat Kematian 24 Jam",
  description:
    "Skim bantuan pengurusan jenazah 24 jam dan manfaat khairat kematian Patuh Syariah khas untuk ahli KOHASiL & keluarga. Pendaftaran pantas melalui potongan gaji (RM10/sebulan).",
  keywords: [
    "kohasil raudhah",
    "skim jenazah",
  ...
  authors: [{ name: "KOHASiL" }],
  robots: "index, follow",
  openGraph: {
    type: "website",
    locale: "ms_MY",
    url: "/",
    siteName: "KOHASiL Raudhah",
    title: "KOHASiL Raudhah — Perlindungan Ketenangan Sekeluarga",
    description:
      "Skim bantuan pengurusan jenazah 24 jam & khairat kematian Patuh Syariah khas untuk ahli KOHASiL dan keluarga.",
    images: [
      {
        url: "/images/opening_background_desktop.png",
        width: 1200,
        height: 630,
        alt: "KOHASiL Raudhah — Skim Pengurusan Jenazah 24 Jam",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "KOHASiL Raudhah — Skim Pengurusan Jenazah & Khairat Kematian",
    description:
      "Perlindungan pengurusan jenazah 24 jam Patuh Syariah untuk warga LHDNM dan keluarga.",
