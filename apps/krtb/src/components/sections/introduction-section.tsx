  ...
  return (
    ...
    >
      <ResponsiveContainer>
        ...
        >
          ...
          <div>
            ...
            <p className="text-sm sm:text-base text-slate-700 leading-relaxed">
              Pihak waris <strong>tidak perlu menyediakan kelengkapan</strong> pengurusan jenazah pada hari kejadian dan <strong>tidak perlu membayar kos semasa</strong> yang terlibat pada hari kejadian. Talian hotline 24 Jam <a href={BRAND.hotlineTel} className="font-bold text-[#1c1c5a] underline">{BRAND.hotline}</a> sedia membantu 24 jam sehari.
            </p>
          </div>
        </motion.div>
        ...
        >
          <OrnamentalDivider className="mt-14" label="KRTB Care" />
        </motion.div>
      </ResponsiveContainer>
    </section>
  );
