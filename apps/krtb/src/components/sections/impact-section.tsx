...
// Replace with real, verified data from KRTB before publication.
const stats = [
  {
    icon: Users,
    value: "10,000+",
    ...
    >
      <ResponsiveContainer>
        <SectionHeading
          ...
          subtitle="KRTB Care hadir untuk memastikan setiap warga pekerja Malaysia mempunyai perlindungan yang mereka perlukan."
          className="mb-12"
        />
        ...
        >
          * Angka dengan nota &ldquo;contoh angka&rdquo; merupakan data ilustrasi dan perlu disahkan oleh pihak KRTB sebelum penerbitan rasmi.
        </p>
      </ResponsiveContainer>
    </section>
  );
