...
const claimsDocuments = [
  ...
  "Borang tuntutan KRTB yang lengkap diisi",
...
const claimsSteps = [
  ...
  { step: 3, action: "Isi Borang Tuntutan", detail: "Borang disediakan oleh pasukan KRTB" },
            ...
            >
              <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
                ...
                >
                  ...
                  >
                    <p className="text-xs leading-relaxed" style={{ color: "var(--color-brand-text-muted)" }}>
                      Senarai ini mungkin berbeza mengikut situasi. Pasukan KRTB akan memandu waris untuk memastikan semua dokumen yang diperlukan disediakan.
                    </p>
                  </div>
                </div>
              </div>
