...
const principles = [
  ...
  },
  {
    ...
    arabic: "وكالة",
    description:
      "Pelantikan KRTB bersama BJSB sebagai wakil peserta untuk melaksanakan usahaniaga Takaful bagi mengurus dana Tabbaru' para peserta dengan beramanah dan yuran wakalah (ujrah) akan disalurkan kepada pihak berkaitan",
  },
];
    ...
    >
      <ResponsiveContainer>
        <SectionHeading
          ...
          subtitle="KRTB Care dibangunkan berdasarkan nilai-nilai Islam — patuh syariah dengan sokongan Jabatan Mufti Negeri Selangor."
        ...
        <motion.p
          ...
          style={{ color: "rgba(255,255,255,0.45)" }}
        >
          * Maklumat pematuhan syariah ini adalah berdasarkan prinsip am. Sila rujuk pihak KRTB atau jawatankuasa syariah yang dilantik untuk pengesahan rasmi.
        </motion.p>
      </ResponsiveContainer>
    </section>
  );
