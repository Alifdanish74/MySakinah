  ...
  return (
    <header
      ...
      style={{
        ...
        boxShadow: "0 1px 0 0 rgba(44,44,132,0.15), 0 2px 12px rgba(44,44,132,0.06)",
      }}
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
        ...
        <a
          ...
          aria-label="KRTB Care — kembali ke bahagian utama"
        >
        ...
        <a
          ...
          aria-label="Daftar sebagai ahli KRTB Care"
        >
          Langgan Sekarang
        </a>
