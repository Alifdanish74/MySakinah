...
const syaratPenyertaan = [
  "Keahlian adalah terbuka kepada semua ahli Koperasi Rakan TEKUN Berhad (KRTB) dan semua kakitangan TEKUN Nasional (semua bangsa & agama).",
  "Tiada pemeriksaan / laporan kesihatan diperlukan untuk mendaftar pakej ini.",
  "Terdapat 3 Pakej Individu dan 3 Pakej Keluarga yang boleh didaftarkan untuk mereka yang berumur 18 tahun ke atas. Pakej Keluarga meliputi perlindungan kepada ahli, pasangan dan anak-anak (jumlah anak mengikut kategori pakej).",
  "Pihak peserta juga boleh menambah pendaftaran untuk anak (luar dari pakej keluarga) yang berumur 18 tahun ke atas dan ibu bapa sebagai peserta tambahan. Ahli wajib mendaftar diri sendiri terlebih dahulu.",
  ...
  "Perlindungan bermula selepas 30 hari dari tarikh 01 / 15hb terdekat selepas pengesahan bayaran potongan gaji di KRTB dan BJSB.",
  "Dalam skim ini, Pihak Pengurusan KRTB dan BJSB dilantik sebagai wakil untuk menguruskan tabung skim Khairat dan bantuan pengurusan jenazah lengkap 24 jam kepada para peserta yang berdaftar.",
...
const syaratTuntutan = [
  ...
  "Segala tuntutan kematian / kemalangan tidak dapat dituntut jika terjadi akibat daripada perbuatan membunuh diri, mabuk, dadah dan penglibatan dalam semua aktiviti yang menyalahi undang-undang.",
    ...
    <main className="py-12 lg:py-20" style={{ background: "var(--color-brand-cream)" }}>
      <ResponsiveContainer>
        ...
        <SectionHeading
          ...
          subtitle="Syarat Penyertaan Skim & Syarat Tuntutan Manfaat Skim Khairat KRTB Care"
          align="center"
        />
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-600">
                  Panduan kelayakan dan pendaftaran ahli KRTB & LHDN
                </p>
              </div>
            </div>
