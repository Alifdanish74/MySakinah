    ...
    >
      <ResponsiveContainer>
        <SectionHeading
          ...
          subtitle="Dengar pengalaman dan maklum balas sebenar daripada peserta serta ahli keluarga yang dilindungi bawah skim KOPETRO."
          className="mb-12"
        />
        ...
        >
          <OrnamentalDivider className="mt-14" label="Testimoni KOPETRO" />
        </motion.div>
      </ResponsiveContainer>
    </section>
  );
